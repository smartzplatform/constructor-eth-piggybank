        ...
        json_schema = {
            ...
            "properties": {
                "signs_count": {
                    ...
                    "title": "Withdrawal decision quorum",
                    "description": "Your new crypto piggy bank is defended by multisignature mechanics. To withdraw any money from piggy bank quorum number of bank owners should send the same withdrawal transactions. Here you define the quorum number. We suggest to set it about ½ of owners. For example 2 of 3, 3 of 5 etc."
                },

                "owners": {
                    "title": "Owners",
                    "description": "Enter owners’ addresses here. Number of owners should be equal or bigger than quorum. If you want to be an owner yourself, don’t forget to add your address also.",
                    "type": "array",
                ...
                "thaw_ts": {
                    "title": "Strict freeze period",
                    "description": "If you want to restrict withdrawing accumulated funds until some specific day and time, enter here when that happy moment will come.",
    ...
    def post_construct(self, fields, abi_array):
        ...
        function_specs = {
            ...
            'Withdraw': {
                ...
                'description': 'Withdraw desired amount of Ether to specific address. Should be sent by quorum number of owners to work.',
                'inputs': [{
                    'title': 'Destination address',
                }, {
                    'title': 'Amount of Ether',
                    'description': 'Ether amount to transfer to Destination address from this contract',
                    'ui:widget': 'ethCount'
                }]
            },
            ...
            '': {
                'title': 'Contribute',
                'description': 'send some amount of Ether to the piggy bank',
            },
            ...
            'revoke': {
                ...
                'description': 'If you changed your mind to withdraw or change owner, send operation hash within this transaction and that operation will be revoked if not yet performed',
                'inputs': [{
                    'title': 'operation hash',
                    'description':'You got operation hash in your withdraw funds or change owner transaction.',
                }],
            },
